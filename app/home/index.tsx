...
export default function Home() {
    ...
    navigation.setOptions({ title: "Home Page", headerShown: true });
...
const styles = StyleSheet.create({
    ...
    messageContainer: { justifyContent: 'flex-start', alignItems: 'flex-start', padding: 10, height: 100, width: '100%', flexDirection: 'column', display: 'flex', backgroundColor: 'white', borderRadius: 10 },
